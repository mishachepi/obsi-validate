...
var require_gray_matter = __commonJS({
  "../node_modules/gray-matter/index.js"(exports2, module2) {
    "use strict";
    var fs = (init_empty_fs(), __toCommonJS(empty_fs_exports));
...
// node_modules/section-matter/index.js
var require_section_matter2 = __commonJS({
  "node_modules/section-matter/index.js"(exports2, module2) {
    "use strict";
...
// node_modules/js-yaml/lib/js-yaml/schema/default_safe.js
var require_default_safe2 = __commonJS({
  "node_modules/js-yaml/lib/js-yaml/schema/default_safe.js"(exports2, module2) {
    "use strict";
    var Schema = require_schema2();
    module2.exports = new Schema({
...
// node_modules/js-yaml/lib/js-yaml/schema/default_full.js
var require_default_full2 = __commonJS({
  "node_modules/js-yaml/lib/js-yaml/schema/default_full.js"(exports2, module2) {
    "use strict";
    var Schema = require_schema2();
    module2.exports = Schema.DEFAULT = new Schema({
      include: [
        require_default_safe2()
      ],
      explicit: [
        require_undefined2(),
        require_regexp2(),
...
var require_loader2 = __commonJS({
  "node_modules/js-yaml/lib/js-yaml/loader.js"(exports2, module2) {
    ...
    var common = require_common2();
    var YAMLException = require_exception2();
    var Mark = require_mark2();
    var DEFAULT_SAFE_SCHEMA = require_default_safe2();
    var DEFAULT_FULL_SCHEMA = require_default_full2();
    var _hasOwnProperty = Object.prototype.hasOwnProperty;
    var CONTEXT_FLOW_IN = 1;
    var CONTEXT_FLOW_OUT = 2;
    var CONTEXT_BLOCK_IN = 3;
...
var require_js_yaml3 = __commonJS({
  "node_modules/js-yaml/lib/js-yaml.js"(exports2, module2) {
    ...
    module2.exports.DEFAULT_SAFE_SCHEMA = require_default_safe2();
    module2.exports.DEFAULT_FULL_SCHEMA = require_default_full2();
    module2.exports.load = loader.load;
    module2.exports.loadAll = loader.loadAll;
    module2.exports.safeLoad = loader.safeLoad;
    module2.exports.safeLoadAll = loader.safeLoadAll;
    ...
    module2.exports.SAFE_SCHEMA = require_default_safe2();
    module2.exports.DEFAULT_SCHEMA = require_default_full2();
    module2.exports.scan = deprecated("scan");
    module2.exports.parse = deprecated("parse");
    module2.exports.compose = deprecated("compose");
    module2.exports.addConstructor = deprecated("addConstructor");
...
// node_modules/js-yaml/index.js
var require_js_yaml4 = __commonJS({
  "node_modules/js-yaml/index.js"(exports2, module2) {
    "use strict";
...
// node_modules/gray-matter/lib/engines.js
var require_engines2 = __commonJS({
  "node_modules/gray-matter/lib/engines.js"(exports, module) {
    "use strict";
    var yaml = require_js_yaml4();
    var engines = exports = module.exports;
    engines.yaml = {
      parse: yaml.safeLoad.bind(yaml),
      stringify: yaml.safeDump.bind(yaml)
...
// node_modules/strip-bom-string/index.js
var require_strip_bom_string2 = __commonJS({
  "node_modules/strip-bom-string/index.js"(exports2, module2) {
    "use strict";
    module2.exports = function(str2) {
      if (typeof str2 === "string" && str2.charAt(0) === "\uFEFF") {
...
var require_utils2 = __commonJS({
  "node_modules/gray-matter/lib/utils.js"(exports2) {
    "use strict";
    var stripBom = require_strip_bom_string2();
    var typeOf = require_kind_of2();
    exports2.define = function(obj, key, val) {
      Reflect.defineProperty(obj, key, {
        enumerable: false,
...
// node_modules/gray-matter/lib/excerpt.js
var require_excerpt2 = __commonJS({
  "node_modules/gray-matter/lib/excerpt.js"(exports2, module2) {
    "use strict";
    var defaults = require_defaults2();
    module2.exports = function(file, options2) {
...
// node_modules/gray-matter/lib/to-file.js
var require_to_file2 = __commonJS({
  "node_modules/gray-matter/lib/to-file.js"(exports2, module2) {
    "use strict";
    var typeOf = require_kind_of2();
...
// node_modules/gray-matter/index.js
var require_gray_matter2 = __commonJS({
  "node_modules/gray-matter/index.js"(exports2, module2) {
    "use strict";
    var fs = (init_empty_fs(), __toCommonJS(empty_fs_exports));
    ...
    var defaults = require_defaults2();
    var stringify = require_stringify2();
    var excerpt = require_excerpt2();
    var engines2 = require_engines2();
    var toFile = require_to_file2();
...
// ../src/schema.ts
function parseProperties(files) {
  const results = [];
  for (const file of files) {
    const { data } = (0, import_gray_matter.default)(file.content);
    if (!data.property_type && data.type_key !== "property") continue;
    const name = data.name ?? file.path.split("/").pop()?.replace("_property.md", "").replace(".md", "") ?? "";
    const pathParts = file.path.split("/");
    pathParts.pop();
    const propIdx = pathParts.lastIndexOf("properties");
    const folder = propIdx >= 0 && propIdx < pathParts.length - 1 ? pathParts.slice(propIdx + 1).join("/") : void 0;
    let linkConstraints;
    if (data.target_type_key || data.target_folder || data.target_has_property || data.target_property_value) {
      linkConstraints = {
        target_type_key: data.target_type_key ?? void 0,
        target_folder: data.target_folder ?? void 0,
        target_has_property: data.target_has_property ?? void 0,
        target_property_value: data.target_property_value ?? void 0
      };
    }
    const prop = {
      name,
      property_type: data.property_type ?? "string",
      allowed_values: data.allowed_values ? toArray(data.allowed_values) : void 0,
      min_value: data.min_value ?? void 0,
      max_value: data.max_value ?? void 0,
      unit: data.unit ?? void 0,
      link_constraints: linkConstraints,
      custom_validator: data.custom_validator ?? void 0,
      folder
    };
...
function parseEntities(files) {
  ...
  for (const file of files) {
    ...
    const name = data.name ?? file.path.split("/").pop()?.replace("_entity.md", "").replace(".md", "") ?? "";
    const rawProps = data.properties ?? {};
    const properties = {};
    for (const [propName, config] of Object.entries(rawProps)) {
      if (config && typeof config === "object") {
        properties[propName] = config;
      } else {
        properties[propName] = {};
      }
    }
    results.push({
      name,
      properties,
      allow_extra: data.allow_extra ?? void 0
    });
  }
  return results;
}
function loadSchema(entityFiles, propertyFiles) {
  ...
  const allowExtraMap = /* @__PURE__ */ new Map();
...
function buildPropertyValidator(prop) {
  switch (prop.property_type) {
    ...
    case "date":
      return external_exports.union([external_exports.string(), external_exports.date()]);
    case "time":
      return external_exports.string();
    case "datetime":
      return external_exports.union([external_exports.string(), external_exports.date()]);
    case "enum": {
      if (prop.allowed_values && prop.allowed_values.length > 0) {
        ...
        return external_exports.preprocess(
          ...
          external_exports.enum([first, ...rest])
        );
      }
      return external_exports.string();
    }
    case "link":
    case "wikilink":
      return external_exports.union([external_exports.string(), external_exports.array(external_exports.string())]);
    case "list":
...
var DEFAULT_TYPE_KEY = "type_key";
function validateFile(file, schema, options2) {
  const typeKeyField = options2?.typeKeyField ?? DEFAULT_TYPE_KEY;
  let data;
  try {
    data = (0, import_gray_matter2.default)(file.content).data;
  } catch (e) {
    return {
      file: file.path,
      entityType: null,
  ...
  const entityType = data[typeKeyField];
  if (!entityType) {
    return {
      file: file.path,
      entityType: null,
  ...
  for (const [field, value] of Object.entries(data)) {
    ...
    if (prop.link_constraints && options2?.vaultIndex) {
      ...
      for (const linkVal of linkValues) {
        const linkErrors = validateLinkTarget(
          ...
          options2.vaultIndex,
          options2.typeKeyField ?? DEFAULT_TYPE_KEY
        );
...
function validateFiles(files, schema, options2) {
  const results = [];
  let valid = 0;
  let invalid = 0;
  let skipped = 0;
  for (const file of files) {
    const result = validateFile(file, schema, options2);
    results.push(result);
...
function validateLinkTarget(rawLink, constraints, index, typeKeyField) {
...
// src/ui/yamlWriter.ts
function yamlScalar(val) {
  const s = String(val);
  if (s.includes(":") || s.includes("#") || s.includes("'") || s.includes('"') || s.includes("\n") || s.startsWith(" ") || s.endsWith(" ") || s === "" || s === "true" || s === "false" || s === "null") {
    return `"${s.replace(/\\/g, "\\\\").replace(/"/g, '\\"')}"`;
  }
  return s;
}
function generateEntityFrontmatter(allowExtra, properties) {
  const lines = ["---", "component_type: entity"];
  if (allowExtra) {
...
function generatePropertyFrontmatter(type, opts) {
  const lines = ["---", `property_type: ${type}`];
...
// src/bridge.ts
var import_gray_matter3 = __toESM(require_gray_matter2());
async function tFileToRawFile(app, file) {
...
function collectMdFiles(folder) {
  ...
  for (const child of folder.children) {
    if (child instanceof import_obsidian.TFile && child.extension === "md") {
      results.push(child);
    } else if (child instanceof import_obsidian.TFolder && child.name !== "_deprecated") {
      results.push(...collectMdFiles(child));
    }
  }
  return results;
}
function getFilesUnderPath(app, folderPath) {
...
function resolveSchemaPaths(schemaDir) {
...
async function ensureSchema(app, schemaDir, cached) {
...
async function bridgeValidateFile(app, file, schema, options2) {
  const rawFile = await tFileToRawFile(app, file);
  const hasLinkConstraints = schema.properties.some((p) => p.link_constraints);
  const opts = hasLinkConstraints ? { ...options2, vaultIndex: await buildVaultIndex(app) } : options2;
...
async function buildVaultIndex(app) {
  ...
  for (const file of files) {
    const content = await app.vault.cachedRead(file);
    try {
      const data = (0, import_gray_matter3.default)(content).data;
...
async function bridgeValidateVault(app, schema, options2) {
...
async function ensureDirectoryExists(app, path) {
...
async function createOrModify(app, filePath, content) {
...
async function writeEntityFile(app, schemaDir, name, allowExtra, properties) {
...
async function writePropertyFile(app, schemaDir, name, type, opts) {
...
async function deprecateSchemaFile(app, filePath) {
...
function entityFilePath(schemaDir, name) {
  const { entitiesPath } = resolveSchemaPaths(schemaDir);
  return `${entitiesPath}/${name}_entity.md`;
}
function propertyFilePath(schemaDir, name) {
  const { propertiesPath } = resolveSchemaPaths(schemaDir);
...
// src/constants.ts
var VIEW_TYPE_RESULTS = "obsi-validate-results";
...
// src/ResultsView.ts
var ResultsView = class extends import_obsidian2.ItemView {
  plugin;
...
var TabManager = class {
  constructor(containerEl, tabs, defaultTab) {
...
// src/ui/EntitiesTab.ts
var import_obsidian4 = require("obsidian");

// src/ui/PropertiesTab.ts
...
async function renderPropertiesTab(containerEl, plugin) {
...
function renderPropertyItem(containerEl, prop, schema, plugin) {
  ...
  let linkConstraints = prop.link_constraints ? { ...prop.link_constraints } : {
    target_type_key: void 0,
    target_folder: void 0,
    target_has_property: void 0,
    target_property_value: void 0
  };
  new import_obsidian3.Setting(content).setName("Type").addDropdown((dd) => {
  ...
  function renderConstraints() {
    ...
    if (currentType === "enum") {
      ...
      new import_obsidian3.Setting(constraintsEl).setName("Min value").addText(
        (text) => text.setValue(minValue != null ? String(minValue) : "").setPlaceholder("none").onChange((val) => {
          minValue = val ? Number(val) : void 0;
        })
      );
      new import_obsidian3.Setting(constraintsEl).setName("Max value").addText(
        (text) => text.setValue(maxValue != null ? String(maxValue) : "").setPlaceholder("none").onChange((val) => {
          maxValue = val ? Number(val) : void 0;
        })
      );
      new import_obsidian3.Setting(constraintsEl).setName("Unit").addText(
        (text) => text.setValue(unit ?? "").setPlaceholder("optional").onChange((val) => {
          unit = val || void 0;
        })
      );
    }
  ...
  renderConstraints();
  new import_obsidian3.Setting(content).setName("Custom validator").setDesc('JS expression. Gets "value". Return false or error string to fail. E.g: typeof value === "string" && value.length > 0').addTextArea(
    (text) => text.setValue(customValidator).setPlaceholder('typeof value === "string" && value.length > 0').onChange((val) => {
      customValidator = val;
    })
  );
  ...
  saveBtn.addEventListener("click", async () => {
    ...
    try {
      const hasLinkConstraints = (currentType === "link" || currentType === "wikilink" || currentType === "list") && (linkConstraints.target_type_key || linkConstraints.target_folder || linkConstraints.target_has_property || linkConstraints.target_property_value);
      await writePropertyFile(plugin.app, plugin.settings.schemaDir, prop.name, currentType, {
        allowed_values: currentType === "enum" ? allowedValues : void 0,
        min_value: currentType === "number" ? minValue : void 0,
        max_value: currentType === "number" ? maxValue : void 0,
        unit: currentType === "number" ? unit : void 0,
        custom_validator: customValidator || void 0,
        link_constraints: hasLinkConstraints ? linkConstraints : void 0
      });
      plugin.schema = null;
      new import_obsidian3.Notice(`Property "${prop.name}" saved.`);
      ...
      new import_obsidian3.Notice(`Failed to save: ${e}`);
    } finally {
  ...
  archiveBtn.addEventListener("click", () => {
    new ConfirmArchiveModal(plugin.app, "property", prop.name, async () => {
      ...
      try {
        ...
        plugin.schema = null;
        new import_obsidian3.Notice(`Property "${prop.name}" archived.`);
        details.remove();
      } catch (e) {
        new import_obsidian3.Notice(`Failed to archive: ${e}`);
      }
    }).open();
  });
}
function renderLinkConstraintsEditor(containerEl, constraints, schema, onChange) {
  ...
  new import_obsidian3.Setting(containerEl).setName("Target type key").setDesc("Linked note must have this entity type").addDropdown((dd) => {
    dd.addOption("", "(any)");
    ...
    dd.onChange((val) => {
      constraints.target_type_key = val || void 0;
      onChange(constraints);
    });
  });
  new import_obsidian3.Setting(containerEl).setName("Target folder").setDesc("Linked note must be in this folder (prefix match)").addText(
    (text) => text.setValue(constraints.target_folder ?? "").setPlaceholder("e.g. Areas/").onChange((val) => {
      constraints.target_folder = val || void 0;
      onChange(constraints);
    })
  );
  new import_obsidian3.Setting(containerEl).setName("Target has property").setDesc("Linked note must have this property defined").addText(
    (text) => text.setValue(constraints.target_has_property ?? "").setPlaceholder("e.g. status").onChange((val) => {
      constraints.target_has_property = val || void 0;
      onChange(constraints);
    })
  );
  ...
  const updatePV = () => {
    ...
    constraints.target_property_value = prop && val ? { property: prop, value: val } : void 0;
    onChange(constraints);
  };
  pvPropInput.addEventListener("change", updatePV);
  pvValInput.addEventListener("change", updatePV);
}
function renderEnumEditor(containerEl, values, onChange) {
  const label = containerEl.createDiv({ cls: "setting-item-name" });
...
function renderNewPropertyForm(tabContentEl, listEl, schema, plugin) {
  ...
  let maxValue;
  let customValidator = "";
  let newLinkConstraints = {};
  new import_obsidian3.Setting(form).setName("Name").addText(
    (text) => text.setPlaceholder("e.g. status").onChange((val) => {
      name = val.trim().toLowerCase().replace(/\s+/g, "_");
    })
  );
  const constraintsEl = form.createDiv({ cls: "obsi-validate-constraints" });
  new import_obsidian3.Setting(form).setName("Type").addDropdown((dd) => {
    for (const t of PROPERTY_TYPES) {
      dd.addOption(t, t);
    }
    dd.setValue(type);
  ...
  function renderNewConstraints() {
    ...
    if (type === "enum") {
      ...
      new import_obsidian3.Setting(constraintsEl).setName("Min value").addText(
        (text) => text.setPlaceholder("none").onChange((val) => {
          minValue = val ? Number(val) : void 0;
        })
      );
      new import_obsidian3.Setting(constraintsEl).setName("Max value").addText(
  ...
  new import_obsidian3.Setting(form).setName("Custom validator").setDesc('JS expression. Gets "value". Return false or error string to fail.').addTextArea(
    (text) => text.setPlaceholder('typeof value === "string" && value.length > 0').onChange((val) => {
      customValidator = val;
    })
  );
  ...
  createBtn.addEventListener("click", async () => {
    if (!name) {
      new import_obsidian3.Notice("Property name is required.");
      return;
    }
    createBtn.disabled = true;
    try {
      const hasLC = (type === "link" || type === "wikilink" || type === "list") && (newLinkConstraints.target_type_key || newLinkConstraints.target_folder || newLinkConstraints.target_has_property || newLinkConstraints.target_property_value);
      await writePropertyFile(plugin.app, plugin.settings.schemaDir, name, type, {
        allowed_values: type === "enum" ? allowedValues : void 0,
        min_value: type === "number" ? minValue : void 0,
        max_value: type === "number" ? maxValue : void 0,
        custom_validator: customValidator || void 0,
        link_constraints: hasLC ? newLinkConstraints : void 0
      });
      plugin.schema = null;
      new import_obsidian3.Notice(`Property "${name}" created.`);
      form.remove();
...
var ConfirmArchiveModal = class extends import_obsidian3.Modal {
  kind;
  name;
  onConfirm;
  constructor(app, kind, name, onConfirm) {
    super(app);
    this.kind = kind;
    this.name = name;
...
// src/ui/EntitiesTab.ts
async function renderEntitiesTab(containerEl, plugin) {
  const schema = await ensureSchema(
    plugin.app,
    plugin.settings.schemaDir,
    plugin.schema
...
function renderEntityItem(containerEl, entity, allPropertyNames, plugin) {
  const details = containerEl.createEl("details", {
    cls: "obsi-validate-schema-item"
  });
  const summary = details.createEl("summary");
  ...
  new import_obsidian4.Setting(content).setName("Allow extra fields").setDesc("Don't warn about unknown properties in this entity type").addToggle(
    (toggle) => toggle.setValue(allowExtra).onChange((val) => {
      allowExtra = val;
    })
  );
  ...
  function renderPropList() {
    ...
    for (const [propName, config] of entries) {
      ...
      reqCheckbox.addEventListener("change", () => {
        properties[propName] = { required: reqCheckbox.checked || void 0 };
      });
      const removeBtn = row.createEl("button", {
        text: "\xD7",
        cls: "obsi-validate-enum-remove"
  ...
  addBtn.addEventListener("click", () => {
    ...
    if (name in properties) {
      new import_obsidian4.Notice(`Property "${name}" already added.`);
      return;
    }
    properties[name] = {};
    selectEl.value = "";
  ...
  saveBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      plugin.schema = null;
      new import_obsidian4.Notice(`Entity "${entity.name}" saved.`);
      const tabEl = containerEl.parentElement;
      if (tabEl) {
        tabEl.empty();
      ...
      new import_obsidian4.Notice(`Failed to save: ${e}`);
    } finally {
      saveBtn.disabled = false;
    }
  });
  archiveBtn.addEventListener("click", () => {
    new ConfirmArchiveModal(plugin.app, "entity", entity.name, async () => {
      ...
      try {
        await deprecateSchemaFile(plugin.app, path);
        plugin.schema = null;
        new import_obsidian4.Notice(`Entity "${entity.name}" archived.`);
        details.remove();
      } catch (e) {
        new import_obsidian4.Notice(`Failed to archive: ${e}`);
      }
    }).open();
  });
}
function renderNewEntityForm(tabContentEl, listEl, allPropertyNames, plugin) {
  const existing = tabContentEl.querySelector(".obsi-validate-new-form");
  if (existing) {
    existing.querySelector("input")?.focus();
    return;
  ...
  const properties = {};
  new import_obsidian4.Setting(form).setName("Name").setDesc("Entity type name (e.g. task, note, book)").addText(
    (text) => text.setPlaceholder("e.g. task").onChange((val) => {
      name = val.trim().toLowerCase().replace(/\s+/g, "_");
    })
  );
  new import_obsidian4.Setting(form).setName("Allow extra fields").addToggle(
    (toggle) => toggle.setValue(allowExtra).onChange((val) => {
      allowExtra = val;
    })
  );
  ...
  addBtn.addEventListener("click", () => {
    ...
    if (pName in properties) {
      new import_obsidian4.Notice(`Property "${pName}" already added.`);
      return;
    }
    properties[pName] = {};
    selectEl.value = "";
  ...
  createBtn.addEventListener("click", async () => {
    if (!name) {
      new import_obsidian4.Notice("Entity name is required.");
      return;
    }
    createBtn.disabled = true;
    try {
      ...
      plugin.schema = null;
      new import_obsidian4.Notice(`Entity "${name}" created.`);
      form.remove();
      const parent = listEl.parentElement;
      parent.empty();
      await renderEntitiesTab(parent, plugin);
    } catch (e) {
      new import_obsidian4.Notice(`Failed to create: ${e}`);
      createBtn.disabled = false;
    }
  });
  cancelBtn.addEventListener("click", () => {
...
// src/SettingsTab.ts
var ObsiValidateSettingTab = class extends import_obsidian5.PluginSettingTab {
  plugin;
  ...
  renderSettings(containerEl) {
    new import_obsidian5.Setting(containerEl).setName("Schema directory").setDesc(
      'Folder containing entities/ and properties/ subdirectories, relative to vault root. Use "." for vault root.'
    ).addText(
      (text) => text.setPlaceholder(".").setValue(this.plugin.settings.schemaDir).onChange(async (value) => {
        this.plugin.settings.schemaDir = value || ".";
        this.plugin.schema = null;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian5.Setting(containerEl).setName("Show ribbon icon").setDesc(
    ...
    new import_obsidian5.Setting(containerEl).setName("Type key field").setDesc(
      "Frontmatter field name that identifies the entity type of a note. For example: type_key, type_name, entity, type."
    ).addText(
      (text) => text.setPlaceholder("type_key").setValue(this.plugin.settings.typeKeyField).onChange(async (value) => {
    ...
    guide.createEl("p", {
      text: "Obsi Validate checks your notes' frontmatter against schemas defined in your vault as regular markdown files. Use the Entities and Properties tabs to manage schemas."
    });
    guide.createEl("h4", { text: "Directory structure" });
    const structPre = guide.createEl("pre");
    const schemaDir = this.plugin.settings.schemaDir === "." ? "" : this.plugin.settings.schemaDir + "/";
    structPre.createEl("code", {
      text: `${schemaDir}entities/      \u2190 entity definitions
  task_entity.md
  note_entity.md
...
// src/main.ts
var ObsiValidatePlugin = class extends import_obsidian6.Plugin {
